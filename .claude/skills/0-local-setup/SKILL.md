...
│  🖥️      │ ←── │ 런타임: Node.js, Python, Bun      │
│          │     │ DB: MySQL, PostgreSQL              │
│          │     │ 앱: VS Code/Cursor, Docker, Chrome │
│          │     │ AI: Claude Code                    │
...
- **asdf** = Node.js, Python 등의 버전을 관리하는 리모컨 (채널 돌리듯 버전을 바꿀 수 있어요)
- **Node.js** = 앱을 돌리는 엔진
- **Python** = 데이터 처리/AI에 쓰는 엔진
- **MySQL/PostgreSQL** = 데이터를 저장하는 창고
- **Docker** = 앱을 상자에 넣어서 어디서든 똑같이 돌리는 도구
...
**4-4. asdf로 런타임 설치**
macOS 스크립트의 asdf 부분과 동일한 로직으로 Node.js, Python, Bun, uv, MySQL, PostgreSQL 설치
